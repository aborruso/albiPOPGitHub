...
### anagrafica albo
titolo="AlboPOP del comune di Castelbuono"
descrizione="L'albo pretorio POP è una versione dell'albo pretorio del tuo comune, che puoi seguire in modo più comodo."
nomecomune="Castelbuono"
webMaster="divuono1977@hotmail.com (Daniele Di Vuono)"
type="Comune"
municipality="Castelbuono"
province="Palermo"
region="Sicilia"
latitude="37.93142580152941"
longitude="14.08885503592226"
country="Italia"
name="Comune di Castelbuono"
uid="istat:082022"
docs="https://albopop.it/comune/castelbuono/"
selflink="https://aborruso.github.io/albiPOPGitHub/c_c067/feed.xml"
### anagrafica albo

iPA="c_c067"

#https://www.comune.castelbuono.pa.it/castelbuono/mc/mc_p_dettaglio.php?id_pubbl=567&x=&sto=&pag=&mittente=&oggetto=&numero=&tipo_atto=&data_dal=&data_al=&datap_dal=&datap_al=&ordin=&servizio=
...
URLBase="https://www.comune.castelbuono.pa.it/castelbuono/mc/mc_p_ricerca.php?&pag=0"
...
if [ $code -eq 200 ]; then
  ...
  for i in {0..3}; do
    curl -kL 'https://www.comune.castelbuono.pa.it/castelbuono/mc/mc_p_ricerca.php?pag='"$i"'' \
...
html.body.tr[0]["@data-id"]
  ...
  while IFS=$'\t' read -r numero mittente oggetto tipo dataInizio rssData; do
    URL="https://www.comune.castelbuono.pa.it/castelbuono/mc/mc_p_dettaglio.php?id_pubbl=$numero"
